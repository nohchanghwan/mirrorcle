...
namespace Microsoft.Samples.Kinect.ControlsBasics
{
    ...
    public partial class SideLateralRaise : UserControl, INotifyPropertyChanged
    {
        ...
        public SideLateralRaise()
        {
            ...
            t = new DispatcherTimer(new TimeSpan(0, 0, 0, 0, 10), DispatcherPriority.Background,
        ...
        {
            String mytime = Convert.ToString(DateTime.Now - start);
            TimerDisplay.Text = mytime;
            System.Console.WriteLine(mytime);
        ...
        private void Reader_FrameArrived(object sender, BodyFrameArrivedEventArgs e)
        {
            ...
            if (dataReceived)
            {
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    FormattedText formattedText = new FormattedText("Your Score", CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, new Typeface("Yj BLOCK Medium"), 15, Brushes.White);
                    System.Windows.Point TxTPosition = new System.Windows.Point(400, 10);
                    dc.DrawText(formattedText, TxTPosition);

                    FormattedText ExerCnt = new FormattedText("Count", CultureInfo.GetCultureInfo("en-us"), FlowDirection.LeftToRight, new Typeface("Yj BLOCK Medium"), 15, Brushes.White);
